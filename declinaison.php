				...
				if ($resvariantsql) {
					...
					if ($numvar > 0) {
						...
						while ($j < $numvar) {
							...
							if ($btest)
								print "VARIANT ref =" . $objvar->ref . "<br>";
						...
						foreach ($listNewProd as $productelement) {
							...
							if ($btest)
								print $newref . "/" . $newlabel . " = " . $priceadd . " - " . $pmpadd . "<br>";
